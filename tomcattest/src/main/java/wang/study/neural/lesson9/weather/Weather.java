package wang.study.neural.lesson9.weather;

import java.io.IOException;
import java.util.ArrayList;

import wang.study.neural.lesson9.NeuralNet;
...
import wang.study.neural.lesson9.util.Chart;
import wang.study.neural.lesson9.util.Data;
import wang.study.neural.lesson9.util.Data.NormalizationTypesENUM;
...
public class Weather {
	...
	public static void main(String args[]){
		...
		try {
			...
			n1.setLearningRate( 0.15 ); //0.15
			n1.setTrainType(TrainingTypesENUM.BACKPROPAGATION);
			n1.setLearningRatePercentageReduce( 0.025 );
