package wang.study.neural.lesson9.ocr;
...
public static void main(String args[]){
		...
		try {
			...
			*/
			...
			n1 = n1.initNet(3, 0, 0, 2);
			
			n1.setTrainSet( new double[][] { { 1.0, 0.0, 1.0 } } );
			
			n1.setMaxEpochs(6000);
			n1.setTargetError(0.00001);
			n1.setLearningRate( 1.0 );
			n1.setTrainType(TrainingTypesENUM.ART);
			n1.setLearningRatePercentageReduce( 0.05 );
