package wang.study.neural.lesson9.learn;

import java.util.ArrayList;

import wang.study.neural.lesson9.InputLayer;
import wang.study.neural.lesson9.NeuralNet;
import wang.study.neural.lesson9.Neuron;
...
public abstract class Training {
	...
	public enum TrainingTypesENUM {
		PERCEPTRON, ADALINE, BACKPROPAGATION, KOHONEN, BACKPROPAGATION_ONLINE, ART;
	}
