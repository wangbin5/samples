package wang.study.neural.lesson8.som;
...
import wang.study.neural.lesson8.learn.Training;
import wang.study.neural.lesson8.validation.Validation;

public class Kohonen extends Training implements Validation {

	public enum KohonenCaseStudyENUM { CARD, FINANCIAL_COMPANY, OCR };
				...
				case OCR:
					switch (winnerNeuron) {
						...
						case 4:
							...
							matrixEstimated[row_i][0] = 5.0;  
							break;
						case 5:
							System.out.println("6");
							matrixEstimated[row_i][0] = 6.0;
							break;
						case 6:
							System.out.println("7");
							matrixEstimated[row_i][0] = 7.0;
							break;
						case 7:
							System.out.println("8");
							matrixEstimated[row_i][0] = 8.0;
							break;
						case 8:
							System.out.println("9");
							matrixEstimated[row_i][0] = 9.0;  
							break;
						case 9:
							System.out.println("10");
							matrixEstimated[row_i][0] = 10.0;
							break;
						default:
							throw new IllegalArgumentException("Error! Without neural clustering...");
					}
